...
given THIS_TOPIC as a topic, and THIS_CONTENT as content, how relevant is the content to the topic? Make sure to return only a JSON object, make sure to use JSON escape sequences for any special characters, and make sure there is no trailing comma. 
Use the below schema for your answer.
{
...
given THIS_TOPIC as a topic, and THIS_CONTENT as content, how sound is the content to the topic? Make sure to return only a JSON object, make sure to use JSON escape sequences for any special characters, and make sure there is no trailing comma.
Use the below schema for your answer.
{
...
given THIS_CONTENT as content, how grammatically correct is the content? Make sure to return only a JSON object, make sure to use JSON escape sequences for any special characters, and make sure there is no trailing comma.
Use the below schema for your answer.
{
...
Make sure to return only a JSON object, make sure to use JSON escape sequences for any special characters, and make sure there is no trailing comma.
Use the below schema for your answer.
{
